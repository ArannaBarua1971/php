    ...
    <nav class="navbar navbar-expand-lg bg-body-tertiary">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                <a class="nav-link" href="#">All Studet Details</a>
                </li>
            </ul>
            </div>
        </div>
        ...
        <div class="row">'
            <form action="controller/controll.php" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input name="boardRoll" type="text" value="<?= empty($_SESSION['info']['boardRoll'])? '': $_SESSION['info']['boardRoll'];?>" class="form-control" id="Broll" placeholder="Enter your Board roll">
                ...
                <div class="mb-3 d-flex justify-content-around">
                    ...
                    <div class="mb-3">
                        ...
                        <input name="cgpa" type="number" value="<?= empty($_SESSION['info']['cgpa'])? '': $_SESSION['info']['cgpa'];?>" class="form-control" id="cgpa" placeholder="Enter your CGPA">
                        <?=empty($_SESSION['errors']["gpaError"])? '':"<strong class='bg-danger p-2'>".$_SESSION['errors']['gpaError']."</strong>";?>
                        <?=empty($_SESSION['errors']["validGpa"])? '':"<strong class='bg-danger p-2'>".$_SESSION['errors']['validGpa']."</strong>";?>
                    </div>
                </div>
