...
$info =mysqli_fetch_assoc($response);
        ...
        <div class="row">
            <form action="./controller/edit.php" method="POST">
                <div class="mb-3">
                    ...
                    <input name="name" type="text" value="<?= empty($info['name'])? '' : $info['name'];?>" class="form-control" id="name" placeholder="Enter your name">
                ...
                <div class="mb-3">
                    ...
                    <input name="boardRoll" type="number" value="<?= empty($info['board_roll'])? '': $info['board_roll'];?>" class="form-control" id="Broll" placeholder="Enter your Board roll">
                ...
                <div class="mb-3">
                    ...
                    <input name="RegRoll" type="number" value="<?= empty($info['reg_roll'])? '': $info['reg_roll'];?>" class="form-control" id="RegRoll" placeholder="Enter your Registration roll">
                </div>
                ...
                <button name="info" type="submit" class="btn btn-primary">Update Data</button>
            </form>
        </div>
    </div>
